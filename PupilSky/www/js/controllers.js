...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $ionicPopup, $rootScope,$state, HOST_IMAGES, $window, LoadingScreen, HTTP, $ionicHistory, ShowMessageAlert) {
    ...
    if($scope.allProfileReturned != null){
      ...
      console.log($scope.allProfileReturned);

      if($scope.allProfileReturned.errorCode != undefined && $scope.allProfileReturned.errorCode != "191"){
...
.controller('PlaylistCtrl', function($scope, $stateParams) {
  ...
  .controller('settingsCtrl', function($scope, $stateParams,$state, $rootScope, HTTP, $window, $ionicHistory, LoadingScreen, ShowMessageAlert) {
